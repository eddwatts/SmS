...
#cam4="screen -dmS cam4 sh -c 'omxplayer --avdict rtsp_transport:tcp --win \"512,192,768,384\" rtsp://10.1.0.25:7447/55bb30a9e68320b007c925f7_2 --crop 0,0,480,360 --live -n -1'"; 
