...
cam5="screen -dmS cam5 sh -c 'omxplayer --avdict rtsp_transport:tcp --win \"0,270,1920,540\" rtsp://10.1.8.252:7447/Rblnw8o0Cn2hXaZl --live -n -1'";
cam6="screen -dmS cam6 sh -c 'omxplayer --avdict rtsp_transport:tcp --win \"1440,540,960,1080\" rtsp://10.1.8.252:7447/dbU6YZHyh9cEtbf7 --live -n -1'";
